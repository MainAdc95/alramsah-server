...
function getFiles(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, p, r, is_active, results, files, err_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                    _a = req.query, p = _a.p, r = _a.r, is_active = _a.is_active;
                    p = Number(p);
                    r = r ? Number(r) : 100;
                    return [4 /*yield*/, db_1.pool.query("SELECT count(*) as results FROM files")];
                case 1:
                    results = (_b.sent()).rows[0].results;
                    results = Number(results);
                    return [4 /*yield*/, db_1.pool.query(fileQuery(is_active ? "WHERE is_active=true" : "", "", r ? "LIMIT " + r : "", "OFFSET " + sum(p, r)))];
                case 2:
                    files = (_b.sent()).rows;
...
function addFile(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var authId, _a, text, image, is_active, fileId, date, err_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    authId = req.query.authId;
                    _a = req.body, text = _a.text, image = _a.image, is_active = _a.is_active;
...
function editFile(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var authId, fileId, _a, text, image, is_active, date, err_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
