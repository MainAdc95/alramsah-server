...
function getFiles(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, p, r, results, files, err_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, db_1.pool.query(fileQuery("", "", r ? "LIMIT " + r : "", "OFFSET " + sum(p, r)))];
                case 2:
                    files = (_b.sent()).rows;
...
function addFile(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var authId, _a, text, image, fileId, date, err_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
...
function editFile(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var authId, fileId, _a, text, image, date, err_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
