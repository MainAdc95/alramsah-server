...
function getUsers(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, authId, p, r, results, users, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, db_1.pool.query(userQuery("WHERE u.user_id != $1", "", r ? "LIMIT " + r : "", "OFFSET " + sum(p, r)), [authId])];
                case 2:
                    users = (_b.sent()).rows;
