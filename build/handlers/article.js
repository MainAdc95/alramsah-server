...
exports.read = exports.publishArticle = exports.archiveArticle = exports.permanentlyDeleteArticle = exports.editArticle = exports.addArticle = exports.getArticles = exports.getArticle = void 0;
...
function getArticles(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, p, r, type, tag, order, search, results, articles, err_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                    _a = req.query, p = _a.p, r = _a.r, type = _a.type, tag = _a.tag, order = _a.order, search = _a.search;
                    p = Number(p);
                    r = r ? Number(r) : 20;
                    return [4 /*yield*/, db_1.pool.query("SELECT count(*) as results FROM articles a WHERE \n            " + (tag
                ...
                case 1:
                    ...
                    return [4 /*yield*/, db_1.pool.query(articleQuery(p
                            ...
                            : "", "ORDER BY  a.created_at " + (order || "desc"), r ? "LIMIT " + r : "", "OFFSET " + sum(p, r)))];
                case 2:
...
function read(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var articleId, number, err_8;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    articleId = req.params.articleId;
                    number = Math.ceil(Math.random() * (15 - 5) + 5);
                    return [4 /*yield*/, db_1.pool.query("\n            UPDATE articles\n            SET\n                readers=readers + $1\n            WHERE article_id=$2\n            ", [number, articleId])];
                case 1:
                    _a.sent();
                    return [2 /*return*/, res.status(200).json("")];
