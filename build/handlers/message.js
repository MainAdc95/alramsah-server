...
function getMessages(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, p, r, authId, results, messages, err_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, db_1.pool.query(messageQuery("WHERE m.to_user=$1", "", r ? "LIMIT " + r : "", "OFFSET " + sum(p, r)), [authId])];
                case 2:
                    messages = (_b.sent()).rows;
                    return [2 /*return*/, res.status(200).json({ results: results, messages: messages })];
                case 3:
                    err_2 = _b.sent();
