...
router.post("/user_role/:userId", auth_1.isLoggedIn, roles_1.isAdmin, user_1.manageUserRole);
router.put("/profile", auth_1.isLoggedIn, user_1.editProfile);
router.put("/user/:userId/user_role", auth_1.isLoggedIn, roles_1.isAdmin, user_1.editRole);
