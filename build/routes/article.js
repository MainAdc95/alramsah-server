...
router.post("/articles", auth_1.isLoggedIn, roles_1.isAdmin, article_1.addArticle);
router.put("/articles/publish_article/:articleId", auth_1.isLoggedIn, roles_1.isAdmin, article_1.publishArticle);
